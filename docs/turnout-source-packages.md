...
- Required columns: `county`, `municipality`, `ward`, `ballots_cast`, `registered_voters`, `registration_denominator_timing`, `source_url`
- Optional columns: `source_level`, `notes`
